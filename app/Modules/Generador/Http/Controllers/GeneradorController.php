<?php 
namespace App\Modules\Generador\Http\Controllers;
...
//Controlador Padre
use App\Modules\Generador\Http\Controllers\Controller;
use App\Modules\Generador\Http\Requests\GeneradorRequest;
...
class GeneradorController extends Controller {
    ...
    public function guardar(GeneradorRequest $request) {
        ...
        if ($this->tabla == '') {
            $request->estructura = true;
            $this->tabla  = trim(strtolower($request->nombre));
        }
    ...
    public function modulos(){
        ...
        foreach (Module::all() as $module) {
            $modulos[$module->getLowerName()] = $module->getName();
        }
