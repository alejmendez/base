<?php $__env->startSection('content-top'); ?>
    ...
    <?php echo $__env->make('base::partials.ubicacion', ['ubicacion' => ['Personas']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script>
var id = <?php echo e(is_null($Personas->id) ? 0 : $Personas->id); ?>;
</script>
            ...
            <div class="form-group multiple-form-group input-group">
                <div class="input-group-btn input-group-select">
                    <select class="form-control" name="tipo_telefono[]" required="">
                        ...
                        <?php $__currentLoopData = $controller->tipotelefono(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" {% if (file.tipo_telefono_id == <?php echo e($id); ?>) { %} selected="selected" {% } %}>
                                <?php echo e($tipo); ?>
            ...
            <div class="form-group multiple-form-group input-group">
                <div class="input-group-btn input-group-select">
                    <select class="form-control" name="principal_tlf[]" required="">
                        <option value="">seleccione ..</option>
                        <?php $__currentLoopData = $controller->principal(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" {% if (file.principal == <?php echo e($id); ?>) { %} selected="selected" {% } %}>
                                <?php echo e($tipo); ?>
