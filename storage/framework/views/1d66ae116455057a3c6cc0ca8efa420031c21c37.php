<?php $__env->startSection('content-top'); ?>
	...
	<?php echo $__env->make('base::partials.ubicacion', ['ubicacion' => ['Generadors', 'Tables']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<form id="formulario">	
	<div class="row">
		<?php echo e(Form::bsSelect('modulo', $controller->modulos(), '', [
			'label' => 'Modulo'
		])); ?>


		<?php echo e(Form::bsSelect('tabla', $controller->tablas(), '', [
			'label' => 'Tabla'
		])); ?>
	...
	<div id="general" class="row">
		<div class="form-group skin-square col-md-4 col-sm-12">
			<h2>General</h2>
			<label>
		...
		<div class="form-group skin-square col-md-8 col-sm-12">
			<h2>Archivos</h2>
