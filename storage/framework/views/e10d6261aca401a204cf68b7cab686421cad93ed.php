<?php $__env->startSection('content-top'); ?>
    ...
    <?php echo $__env->make('base::partials.ubicacion', ['ubicacion' => ['Incidencias']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('content'); ?>
   <div class="row">
      ...
      <input id="archivos" name="archivos" type="hidden" />
        ...
        <?php echo e(Form::bsSelect('modulo', $controller->modulo(), '', [
            'label' => 'Modulo',
            'required' => 'required'
        ])); ?>
